...
Приложение Core — backend с описанием API в формате OpenAPI и Swagger UI для просмотра и вызова методов. Swagger UI отдаётся из контейнера backend; отдельного frontend у инфраструктуры нет.
...
- Предоставлять OpenAPI и Swagger UI по документированным адресам, поддерживать вызов защищённых методов с токеном Keycloak.
