...
Обновляемое видение инфраструктуры, требования и вопросы для согласования: [Vision](vision.md).
...
GitHub хранит исходный код и конфигурацию в монорепозитории. Для CI/CD используется GitHub Actions: проверки, сборка образов и развёртывание. Kubernetes управляет запуском компонентов и их ресурсами. S3 используется для объектного хранения, Kafka — для обмена событиями между приложениями. Команда инфраструктуры определяет связи компонентов, сети, доступы и порядок обновления системы.
